...
rule "2a1"
	...
	then
        [cria_facto(finality("NAVEGACAO_WEB_SIMPLES")), cria_facto(needsDedicatedGPU(false))].
...
rule "2a2"
	...
	then
        [cria_facto(finality("NAVEGACAO_WEB_COMPLEXO")), cria_facto(needsDedicatedGPU(false))].
...
rule "2b1"
	...
	then
        [cria_facto(finality("APLICACOES_OFFICE_BASICO")), cria_facto(needsDedicatedGPU(false))].
...
rule "2b2"
	...
	then
        [cria_facto(finality("APLICACOES_OFFICE_PROFISSIONAL")), cria_facto(needsDedicatedGPU(false))].
...
rule "2c1"
	...
	then
        [cria_facto(finality("APLICACOES_PROFISSIONAIS_COM_BASE_DADOS")), cria_facto(needsDedicatedGPU(false))].
...
rule "2c2"
	...
	then
        [cria_facto(finality("APLICACOES_PROFISSIONAIS_SEM_BASE_DADOS")), cria_facto(needsDedicatedGPU(false))].
...
rule "3d1"
	...
	then
        [cria_facto(finality("JOGOS_BASICOS")), cria_facto(needsDedicatedGPU(false))].
...
rule "3e1"
	...
	then
        [cria_facto(finality("PROGRAMAS_AVANCADOS_MODELACAO_3D")), cria_facto(needsDedicatedGPU(true))].
...
rule "3e2"
	...
	then
        [cria_facto(finality("PROGRAMAS_AVANCADOS_DESIGN_GRAFICO")), cria_facto(needsDedicatedGPU(true))].
...
rule "3e3"
	...
	then
        [cria_facto(finality("PROGRAMAS_AVANCADOS_CALCULO_MATEMATICO")), cria_facto(needsDedicatedGPU(false))].
...
rule "3f1"
	...
	then
        [cria_facto(finality("GAMING")), cria_facto(needsDedicatedGPU(true))].
...
rule "3g1"
	...
	then
        [cria_facto(finality("TRATAMENTO_DE_IMAGEM")), cria_facto(needsDedicatedGPU(true))].
...
rule "3h1"
	...
	then
        [cria_facto(finality("EDICAO_DE_VIDEO_4k_8K")), cria_facto(needsDedicatedGPU(true))].
...
rule "r5a1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(8)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(120)), cria_facto(durationDayChoice(1))].
...
rule "r5a2"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(8)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(120)), cria_facto(durationDayChoice(2))].
...
rule "r5a3"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(480)), cria_facto(minStorage_minRAMPreferred(8)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(120)), cria_facto(durationDayChoice(1))].
...
rule "r5a4"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(480)), cria_facto(minStorage_minRAMPreferred(8)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(120)), cria_facto(durationDayChoice(2))].
...
rule "r5b1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(120)), cria_facto(durationDayChoice(1))].
...
rule "r5b2"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(3600)), cria_facto(adequateMinCPUBenchmark(120)), cria_facto(durationDayChoice(2))].
...
rule "r5b3"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(480)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(120)), cria_facto(durationDayChoice(1))].
...
rule "r5b4"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(480)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(3600)), cria_facto(adequateMinCPUBenchmark(120)) and  cria_facto(durationDayChoice(2))].
...
rule "r5d1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(140)), cria_facto(durationDayChoice(1))].
...
rule "r5d2"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(3600)), cria_facto(adequateMinCPUBenchmark(140)), cria_facto(durationDayChoice(2))].
...
rule "r5d4"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(480)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(3600)), cria_facto(adequateMinCPUBenchmark(140)), cria_facto(durationDayChoice(2))].
...
rule "r5e1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(480)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(3600)), cria_facto(adequateMinCPUBenchmark(140))].
...
rule "r5e21"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(480)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(140))].
...
rule "r5e22"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(3600)), cria_facto(adequateMinCPUBenchmark(140))].
...
rule "r5d1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(16)), cria_facto(minStorage_minRAMSpeed(3600)), cria_facto(adequateMinCPUBenchmark(140)), cria_facto(adequateMinGPUBenchmark(100))].
...
rule "r5e1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(170))].
...
rule "r5f1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minScndStorage_capacity(1000)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(170))].
...
rule "r5f2"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minScndStorage_capacity(2000)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(3200)), cria_facto(adequateMinCPUBenchmark(180))].
...
rule "r5g1"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minScndStorage_capacity(1000)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(170)), cria_facto(adequateMinGPUBenchmark(100))].
...
rule "r5h11"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(170)), cria_facto(adequateMinGPUBenchmark(120))].
...
rule "r5h13"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(170)), cria_facto(adequateMinGPUBenchmark(170))].
...
rule "r5h14"
	...
	then
        [cria_facto(minStorage_isSSD(true)), cria_facto(minStorage_capacity(240)), cria_facto(minStorage_minRAMPreferred(32)), cria_facto(minStorage_minRAMSpeed(2600)), cria_facto(adequateMinCPUBenchmark(170)), cria_facto(adequateMinGPUBenchmark(200))].
...
rule "r10a1"
        ...
        then
        [cria_facto(needsCPUCooler(true)), cria_facto(cpuCooler_isWaterCooled(true))].
...
rule "r10a2"
        ...
        then
        [cria_facto(needsCPUCooler(true)), cria_facto(cpuCooler_isFanless(true))].
...
rule "r12a1"
	...
	then
        [cria_facto(caseColorPreferred("black"))].
...
rule "r12a2"
	...
	then
        [cria_facto(caseColorPreferred("white"))].
